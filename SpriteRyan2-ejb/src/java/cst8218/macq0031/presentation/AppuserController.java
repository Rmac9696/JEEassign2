...
import cst8218.macq0031.entity.Appuser;
import cst8218.macq0031.presentation.util.JsfUtil;
import cst8218.macq0031.presentation.util.PaginationHelper;
import cst8218.macq0031.entity.AppuserFacade;
...
public class AppuserController implements Serializable {
    ...
    @EJB
    private cst8218.macq0031.entity.AppuserFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle2").getString("AppuserCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle2").getString("AppuserUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle2").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle2").getString("AppuserDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle2").getString("PersistenceErrorOccured"));
        }
    }
